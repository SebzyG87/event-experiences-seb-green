  ...
  return (
    <>
      <motion.button
        ...
        className="fixed bottom-6 left-6 z-50 w-12 h-12 rounded-full bg-gradient-to-r from-amber-500 to-orange-500 shadow-lg flex items-center justify-center text-white hover:scale-110 transition-transform"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 left-6 w-[350px] h-[500px] max-h-[65vh] bg-background/95 backdrop-blur-xl border border-amber-500/20 rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col"
          >
                ...
                <div className="h-full flex flex-col p-4 gap-4">
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-4 py-2 bg-muted/50 border border-border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/50"
                    />
                  </div>
                  <div className="flex-1 overflow-y-auto space-y-2">
                    {filteredArticles.map((article) => (
                      <button
                        key={article.slug}
                        className="w-full text-left p-3 rounded-lg bg-muted/30 hover:bg-amber-500/10 hover:border-amber-500/30 border border-transparent transition-all"
                      >
                        <p className="text-xs text-amber-500 font-medium mb-1">{article.category}</p>
